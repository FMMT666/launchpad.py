...
def main():
    ...
    if launchpad.LaunchpadProMk3().Check():
        ...
        if lp.Open():
            mode = "promk3"
    elif launchpad.LaunchpadPro().Check():
    ...
    while True:
        ...
        if events:
            # x and y button codes of >=255 indicate that this is a pressure
            # value
            if events[0] >= 255 and events[1] >= 255:
                ...
                #   It always returns
                #   a fake coordinate of "255", so that the pressure events
                ...
                if events[2] > 0:
                    ...
                    print(" RELEASED: ", end='')
                # TODO
                print(str(events[0]) + " " + str(events[1]) + " " + str(
                    events[2]))
